...
public class ConcreteTxtProduct extends Product {
	...
	public void fuegeInDateiHinzu(Object object) throws IOException {
		...
		this.bw.write("�ffnungszeit des Freizeitbads:\t\t" + ((Freizeitbad) object).getGeoeffnetVon() + " - "
				+ ((Freizeitbad) object).getGeoeffnetBis() + "\n");
		this.bw.write("Beckenl�nge des Freizeitbads:\t\t" + ((Freizeitbad) object).getBeckenlaenge() + "\n");
